...
Section WithParameters.
  ...
  Context {ok : Types.ok}
    ...
    (*For now, an instance of PrimeFieldParameters. If for some reason in the future, extended field arithmetic will be generated by the Fiat Crypto -> Bedrock2 pipeline, then generalizing to AbstractField.FieldParameters would be needed.*)
